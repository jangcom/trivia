...
Public Sub ExportPageAsPNG()
    ...
    vsoApplicationSettings.SetRasterExportResolution visRasterUseCustomResolution, 300#, 300#, visRasterPixelsPerInch
    vsoApplicationSettings.SetRasterExportSize visRasterFitToSourceSize, 3.604167, 3.604167, visRasterInch
